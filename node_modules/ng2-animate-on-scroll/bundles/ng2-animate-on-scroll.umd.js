    ...
    ***************************************************************************** */
    ...
    var ScrollService = /** @class */ (function () {
        function ScrollService() {
            ...
            this.scrollObs = typeof window !== 'undefined' ? rxjs.fromEvent(window, 'scroll') : rxjs.EMPTY;
            ...
            this.resizeObs = typeof window !== 'undefined' ? rxjs.fromEvent(window, 'resize') : rxjs.EMPTY;
            // initiate subscription to update values
